...
Version: 1.7.0.1
Plugin URI: https://wordpress.org/plugins/social-payments/
...
Author: Marius Herea
Author URI: https://wptinker.com/

Copyright 2016 Marius Herea (email: marius.herea@gmail.com)
...
define('SP_PLUGIN_VERSION', '1.7.0.1');

function spjscss() {
    wp_enqueue_style('sp-main', plugins_url('css/sp-main-min.css', __FILE__));
}
function spjscss_admin() {
    wp_enqueue_style('fa', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.6.1/css/font-awesome.min.css');
		...
		<div id="poststuff" class="ui-sortable meta-box-sortables">
            ...
            <div class="postbox">
                <div class="inside">
                    ...
                    <p>&copy;<?php echo date('Y'); ?> <a href="//wptinker.com/" rel="external"><strong>wpTinker</strong>.com</a> &middot;
                </div>
            </div>
		</div>
	</div>
